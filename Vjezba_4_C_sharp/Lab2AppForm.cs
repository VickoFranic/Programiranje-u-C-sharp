...
namespace Labs
{
	...
	public class Lab2AppForm : System.Windows.Forms.Form
	{
		...
		private void button1_Click(object sender, System.EventArgs e)
		{
			...
			{
                textBoxVal = asf.getTextBoxInput();
                shapeType = asf.getSelectedType();
            
                Shape newShape = (Shape)Activator.CreateInstance(shapeType, textBoxVal);    
                DataModel.getAllElementsList().Add(newShape);

                listBox1.Items.Add(newShape);
                label2.Text = "Total area = " + DataModel.getTotalPerimeter().ToString() +
                              "Total perimeter = " + DataModel.getTotalArea().ToString();
