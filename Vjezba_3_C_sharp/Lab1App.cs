...
namespace Labs
{
	...
	class Lab1App
	{
        /** Helper DataModel variable. 
         * Used for raising events from private methods in this class.
         */
		...
		static void Main(string[] args)
		{
            ...
            /**
             * Attaching event handler method to DataModel (Lamba expression used)
             * Class Lab1App subscribed to publisher`s (DataModel) event (CircleAdded)
             */
			...
			{				
				...
				if(input.Trim()!="")
				{
					try
					{
                        ...
                        // Raise event after new circle is added to DataModel
